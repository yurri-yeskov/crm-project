    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        <tr class="text-left font-bold">
          ...
          <th class="px-6 pt-6 pb-4">Contact</th>
          <th class="px-6 pt-6 pb-4">Company</th>
          <th class="px-6 pt-6 pb-4">Town</th>
          <th class="px-6 pt-6 pb-4">Area</th>
          <th class="px-6 pt-6 pb-4">Tel</th>
          <th class="px-6 pt-6 pb-4">Mobile</th>
          <th class="px-6 pt-6 pb-4">e-mail</th>
          <th class="px-6 pt-6 pb-4">Web</th>
          <th class="px-6 pt-6 pb-4">Brands</th>
          <th class="px-6 pt-6 pb-4" colspan="2">Comments</th>
        </tr>
        <tr v-for="organization in organizations.data" :key="organization.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          ...
          <td class="border-t">
            <inertia-link class="px-6 py-4 flex items-center focus:text-indigo-500" :href="route('organizations.edit', organization.id)">
              {{ organization.date | dateParse('YYYY-MM-DD') | dateFormat('MMMM D, YYYY')}}
              <icon v-if="organization.deleted_at" name="trash" class="flex-shrink-0 w-3 h-3 fill-gray-400 ml-2" />
            </inertia-link>
          </td>
          <td class="border-t">
